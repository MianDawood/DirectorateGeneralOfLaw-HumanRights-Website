    ...
    <section class="bg-slate-50 py-16">
        <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
                <!-- Search -->
                <form method="GET" action="{{ route('tenders') }}" class="relative w-full md:w-96">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by title, reference no, or description..."
                ...
                <p class="text-sm text-slate-500">Showing {{ $tenders->total() }} active tender(s)</p>
            </div>
