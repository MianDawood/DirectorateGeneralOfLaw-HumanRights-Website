                    ...
                    <div class="lg:col-span-3 reveal-on-scroll">
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                            ...
                            <div class="p-8 lg:p-10">
                                ...
                                <form id="contactForm" class="space-y-5" method="POST" action="{{ route('contact.store') }}">
                                    @csrf
                                    ...
                                    <div class="grid md:grid-cols-2 gap-5">
                                        <div>
                                            <label
                                                ...
                                                Number</label>
                                            <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+92 300 1234567"
                                                class="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#02B1EB]/20 focus:border-[#02B1EB] transition-all placeholder:text-slate-400" />
                                        </div>
                                        <div>
                                            <label
                                    ...
                                    <div>
                                        ...
                                        <textarea name="message" required rows="8"
                                            ...
                                            class="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#02B1EB]/20 focus:border-[#02B1EB] transition-all resize-none placeholder:text-slate-400">{{ old('message') }}</textarea>
                                    </div>
