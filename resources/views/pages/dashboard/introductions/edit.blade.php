                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <template x-if="head.image">
                                        <img :src="head.image.startsWith('uploads/') || head.image.startsWith('images/') ? '{{ asset('') }}' + head.image : '{{ asset('storage/') }}' + head.image" class="w-10 h-10 object-cover rounded-lg border">
                                    </template>
                                </div>
                            </div>
