                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="tiktok_url" value="{{ old('tiktok_url', $settings->tiktok_url) }}" placeholder="https://tiktok.com/..."
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-6">
                <div>
                    ...
                    <input type="text" name="site_name" value="{{ old('site_name', $settings->site_name) }}" placeholder="Directorate of Human Rights"
                           class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm focus:border-slate-900 outline-none transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if($settings->logo)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $settings->logo) }}" alt="Current Logo" class="h-20 object-contain border p-2 rounded bg-gray-50 dark:bg-gray-900">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        @if($settings->favicon)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $settings->favicon) }}" alt="Current Favicon" class="h-16 w-16 object-contain border p-2 rounded bg-gray-50 dark:bg-gray-900">
                            </div>
                        @endif
                ...
                <div>
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $settings->meta_title) }}" placeholder="Directorate of Human Rights | Khyber Pakhtunkhwa"
                           class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm focus:border-slate-900 outline-none transition-all">
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="3" placeholder="Short site description shown in search engine results..."
                              class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm focus:border-slate-900 outline-none transition-all">{{ old('meta_description', $settings->meta_description) }}</textarea>
                </div>

                <div>
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Meta Keywords</label>
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $settings->meta_keywords) }}" placeholder="human rights, KP, NGOs, directorate"
                           class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm focus:border-slate-900 outline-none transition-all">
                </div>
            </div>
        </div>
