                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" required
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm px-3 py-2 focus:border-blue-500 focus:ring-blue-500">{{ old('description') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="category" name="category" required
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
                                        <option value="Annual Report" {{ old('category') === 'Annual Report' ? 'selected' : '' }}>Annual Report</option>
                                        <option value="Legal Act" {{ old('category') === 'Legal Act' ? 'selected' : '' }}>Legal Act</option>
