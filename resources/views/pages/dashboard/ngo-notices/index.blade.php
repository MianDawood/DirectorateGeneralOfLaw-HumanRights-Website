            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.ngo-notices.create') }}"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($notices as $notice)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            {{ Str::limit($notice->title, 70) }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $notice->created_at->format('M d, Y') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($notice->is_public_notice)
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.ngo-notices.edit', $notice) }}"
                                                   class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form method="POST" action="{{ route('admin.ngo-notices.destroy', $notice) }}"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        No notices found.
                                        <a href="{{ route('admin.ngo-notices.create') }}" class="text-blue-600 hover:text-blue-900 ml-2">Create one now</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
