    ...
    <div class="px-4 py-8 mx-auto max-w-7xl">
        ...
        <div class="mt-12">
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <a href="{{ route('admin.news-events.index') }}" class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700/50">
