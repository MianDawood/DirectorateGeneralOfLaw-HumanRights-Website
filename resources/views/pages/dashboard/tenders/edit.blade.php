                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                          class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('description', $tender->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="reference_no" id="reference_no" value="{{ old('reference_no', $tender->reference_no) }}"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       required>
                                @error('reference_no')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="date" name="publish_date" id="publish_date" value="{{ old('publish_date', optional($tender->publish_date)->format('Y-m-d')) }}"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       required>
                                @error('publish_date')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="date" name="closing_date" id="closing_date" value="{{ old('closing_date', optional($tender->closing_date)->format('Y-m-d')) }}"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       required>
                                @error('closing_date')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1">
                                    @if($tender->file_path)
                                        <a href="{{ route('tenders.download', $tender->id) }}" class="text-blue-600 hover:text-blue-900">
                                            {{ $tender->file_path }}
                                        </a>
                                    @else
