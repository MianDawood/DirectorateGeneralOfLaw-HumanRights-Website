            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.provincial-departments.create') }}"
                    ...
                    <form method="GET" action="{{ route('admin.provincial-departments.index') }}"
                        ...
                        @if(!empty($search))
                            <a href="{{ route('admin.provincial-departments.index') }}"
                                ...
                                @forelse($departments as $department)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('admin.provincial-departments.edit', $department) }}"
                                               class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                                            <form method="POST" action="{{ route('admin.provincial-departments.destroy', $department) }}"
                                                  class="inline"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                            {{ empty($search) ? 'No departments found.' : 'No departments match your search.' }}
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
