<x-form-layout
    title="Registration Form - PART-4"
    subtitle="SCHEDULE-I | PART-4: MANAGEMENT & FOCAL PERSON"
    step="Step 4 of 11: Management & Focal Person"
...
>
    <section>
        ...
        <template id="board-member-row-template">
            @include('pages.partials.board_member_row')
        </template>
    </section>
