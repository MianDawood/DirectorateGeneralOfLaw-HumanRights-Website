<div class="relative" x-data="{
    ...
    >
        {{-- <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
            <img src="{{ asset('images/logo/logo.jpg') }}" alt="User" />
        </span> --}}
    ...
    <!-- Dropdown End -->
    @else
    <a href="{{ route('login') }}" class="flex items-center text-gray-700 dark:text-gray-400 font-medium text-theme-sm hover:text-primary transition-colors">
        Login
    </a>
    @endauth
</div>
