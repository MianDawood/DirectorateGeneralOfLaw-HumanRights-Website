                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 divide-x divide-slate-100">
                    ...
                    <div class="flex items-center gap-4 py-6 px-4 lg:px-6 group cursor-pointer">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs font-bold text-slate-700"><?php echo e($settings->contact_phone ?? '091-9217202'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 py-6 px-4 lg:px-6 group cursor-pointer">
                        <div
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs font-bold text-slate-700 truncate"><?php echo e($settings->contact_email ?? 'dhr.kpk@gmail.com'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 py-6 px-4 lg:px-6 group cursor-pointer">
                        <div
                            ...
                            <div class="p-7 space-y-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">
                                            Office Address</p>
                                        <p class="text-sm text-slate-700 leading-relaxed"><?php echo nl2br(e($settings->contact_address ?? 'Plot No. 21, Sector B-2, Phase-V, Hayatabad, Peshawar, Khyber Pakhtunkhwa.')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">
                                            Phone Numbers</p>
                                        <p class="text-sm text-slate-700 font-semibold"><?php echo e($settings->contact_phone ?? '+92 91 9217202'); ?></p>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">
                                            Email Addresses</p>
                                        <a href="mailto:<?php echo e($settings->contact_email ?? 'dhr.kpk@gmail.com'); ?>"
                                            class="block text-sm text-[#02B1EB] font-semibold hover:underline"><?php echo e($settings->contact_email ?? 'dhr.kpk@gmail.com'); ?></a>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            ...
                                            <select name="subject" required
                                                ...
                                                <option value="complaint" <?php echo e(old('subject') === 'complaint' ? 'selected' : ''); ?>>File a Complaint</option>
                                                <option value="legal" <?php echo e(old('subject') === 'legal' ? 'selected' : ''); ?>>Legal Assistance</option>
                                                <option value="human-rights" <?php echo e(old('subject') === 'human-rights' ? 'selected' : ''); ?>>Human Rights Issue</option>
