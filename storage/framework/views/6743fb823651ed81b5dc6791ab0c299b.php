        ...
        <section class="py-24 bg-white">
            <div class="max-w-[1200px] mx-auto px-6 lg:px-20">
                <div class="space-y-12 reveal-stagger">
                    <?php $__empty_1 = true; $__currentLoopData = $guidelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $guideline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex flex-col md:flex-row items-start gap-10 group">
                            <div
                                class="w-16 h-16 <?php echo e(($index % 2 == 0) ? 'bg-[#123B2D]' : 'bg-[#02B1EB]'); ?> text-white rounded-2xl flex items-center justify-center shrink-0 font-outfit font-black text-2xl shadow-xl group-hover:scale-110 transition-transform duration-500">
                                <?php echo e($index + 1); ?></div>
                            <div class="pt-2">
                                <h3 class="font-outfit text-2xl font-bold text-[#123B2D] uppercase mb-4 tracking-tight">
                                    <?php echo e($guideline->title); ?></h3>
                                <p class="text-slate-500 text-lg leading-relaxed"><?php echo e($guideline->description); ?></p>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/ngo_guidelines.blade.php ENDPATH**/ ?>