                        ...
                        <div class="p-0 sm:p-3 rounded-[24px] sm:rounded-[48px]">
                            ...
                            <div id="videoAccordion"
                                ...
                                <div data-acc-item
                                    ...
                                    style="flex:5">
                                    <img src="<?php echo e(asset('images/event 1.jpeg')); ?>" alt="Event"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/event 2.jpg')); ?>" alt="Event"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/event 3.jpg')); ?>" alt="Event"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                                        <i data-lucide="play"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/event 4.jpg')); ?>" alt="Event"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                                        <i data-lucide="play"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/event 5.jpg')); ?>" alt="Event"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                                        <i data-lucide="play"
                        ...
                        <div
                            ...
                            <?php if($isVideo): ?>
                                <div class="relative h-64 w-full bg-black overflow-hidden group/video cursor-pointer"
                                    ...
                                    <video
                                        ...
                                        preload="metadata"
                                        <?php if($thumbSrc): ?> poster="<?php echo e($thumbSrc); ?>" <?php endif; ?>
                                        ...
                                        <source src="<?php echo e($mediaSrc); ?>#t=0.001" type="video/mp4">
                            ...
                            <?php else: ?>
                                <div class="relative h-64 w-full overflow-hidden">
                                    <img src="<?php echo e($thumbSrc ?? ''); ?>" alt="<?php echo e($video->title ?? 'Video Thumbnail'); ?>"
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/videogallery.blade.php ENDPATH**/ ?>