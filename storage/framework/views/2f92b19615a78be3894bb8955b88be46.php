...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-layout','data' => ['title' => 'Registration Form - PART-9','subtitle' => 'SCHEDULE-I | PART-9: EXPANDED FINANCIAL & AUDIT INFORMATION','step' => 'Step 9 of 11: Expanded Financial & Audit Information','backRoute' => 'registration_form_part8','backLabel' => 'Back to Part 8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Registration Form - PART-9','subtitle' => 'SCHEDULE-I | PART-9: EXPANDED FINANCIAL & AUDIT INFORMATION','step' => 'Step 9 of 11: Expanded Financial & Audit Information','backRoute' => 'registration_form_part8','backLabel' => 'Back to Part 8']); ?>
    <section>
    ...
    <div class="pt-10 border-t border-slate-100 flex flex-col items-center gap-5">
        <div class="flex flex-col sm:flex-row gap-4 w-full max-w-2xl justify-center">
            ...
            <a href="<?php echo e(route('registration_form_part10')); ?>"
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/registration_form_part9.blade.php ENDPATH**/ ?>