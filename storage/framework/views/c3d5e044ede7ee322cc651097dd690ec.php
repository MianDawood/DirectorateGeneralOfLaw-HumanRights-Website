...
<div class="px-4 py-8 mx-auto max-w-4xl">
    ...
    <form id="directives-form" method="POST" action="<?php echo e(route('admin.ngo-directives.update')); ?>" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div>
                    ...
                    <input type="text" name="heading" value="<?php echo e(old('heading', $directive->heading)); ?>" placeholder="e.g. Mandatory Registration Under"
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div>
                    ...
                    <textarea name="desc_2" rows="4" placeholder="Detailed legal directive text..."
                              class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 p-4 text-sm text-gray-600 dark:text-gray-300 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all outline-none"><?php echo e(old('desc_2', $directive->desc_2)); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="card_1_title" value="<?php echo e(old('card_1_title', $directive->card_1_title)); ?>"
                    ...
                    <div>
                        ...
                        <textarea name="card_1_desc" rows="5" placeholder="Use [brackets] for red text..."
                                  class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 p-3 text-sm text-gray-600 dark:text-gray-300 focus:border-brand-500 outline-none transition-all"><?php echo e(old('card_1_desc', $directive->card_1_desc)); ?></textarea>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Card Title</label>
                        <input type="text" name="card_2_title" value="<?php echo e(old('card_2_title', $directive->card_2_title)); ?>"
                               class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 p-3 text-sm font-bold text-gray-900 dark:text-white focus:border-brand-500 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Card Description</label>
                        <textarea name="card_2_desc" rows="5" placeholder="Use [brackets] for red text..."
                                  class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 p-3 text-sm text-gray-600 dark:text-gray-300 focus:border-brand-500 outline-none transition-all"><?php echo e(old('card_2_desc', $directive->card_2_desc)); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/ngo-directives/edit.blade.php ENDPATH**/ ?>