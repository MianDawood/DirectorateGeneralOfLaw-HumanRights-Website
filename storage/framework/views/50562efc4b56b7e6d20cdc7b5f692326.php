    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden flex items-center gap-2">
                <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>" alt="Logo" class="w-8 rounded-full" />
                <span class="font-bold text-lg text-gray-900 dark:text-white whitespace-nowrap">HR KP</span>
            </a>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <button
                    ...
                    :aria-label="$store.theme.theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'"
                    type="button">
                    <!-- Sun (shown in dark mode) -->
                    <svg x-show="$store.theme.theme === 'dark'" class="w-5 h-5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
                    <!-- Moon (shown in light mode) -->
                    <svg x-show="$store.theme.theme === 'light'" class="w-5 h-5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/layouts/app-header.blade.php ENDPATH**/ ?>