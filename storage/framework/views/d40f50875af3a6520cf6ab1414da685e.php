            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
                <?php if(isset($application) && $application): ?>
                    ...
                    <div class="p-8 space-y-6">
                        <div class="border-b border-slate-100 pb-4">
                            ...
                            <p class="text-xl font-black text-slate-800 mt-1"><?php echo e(strtoupper($ngoName)); ?></p>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest">Registration No.</p>
                                <p class="text-lg font-bold text-slate-700 mt-1"><?php echo e($registration_no); ?></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-slate-700 mt-1">
                                    <?php echo e($issueDate ? $issueDate->format('d/m/Y') : 'N/A'); ?>
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-slate-700 mt-1">
                                    <?php echo e($issueDate ? $issueDate->copy()->addYears(3)->format('d/m/Y') : 'N/A'); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="p-8 text-center">
                        <p class="text-slate-600 mb-6">The registration number <strong class="text-slate-900"><?php echo e($registration_no); ?></strong> is not recognized by our system, or the organization has been suspended.</p>
                        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 text-white font-bold rounded-xl hover:bg-black transition-colors no-underline">
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/verify_certificate.blade.php ENDPATH**/ ?>