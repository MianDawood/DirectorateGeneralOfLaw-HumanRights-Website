...
<aside id="sidebar"
                ...
                <?php $__currentLoopData = $menuGroup['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($item['subItems'])): ?>
                        <?php $__currentLoopData = $item['subItems']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            if (currentPath === '<?php echo e(ltrim(parse_url($subItem['path'], PHP_URL_PATH), '/')); ?>') {
    ...
    <div class="pt-8 pb-7 flex items-center gap-3"
        ...
        <a href="/" class="flex items-center gap-3">
            <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>" alt="Logo" class="w-10 rounded-full" />
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                  class="font-bold text-xl text-gray-900 dark:text-white whitespace-nowrap">HR KP</span>
        </a>
    </div>
                                ...
                                <li>
                                    <?php if(isset($item['subItems'])): ?>
                                        ...
                                        <button @click="toggleSubmenu(<?php echo e($groupIndex); ?>, <?php echo e($itemIndex); ?>)"
                                            ...
                                            :class="[
                                                isParentActive(<?php echo e(json_encode($item)); ?>) ?
                                            ...
                                            <!-- Icon -->
                                            <span :class="isParentActive(<?php echo e(json_encode($item)); ?>) ?
                                     ...
                                     <?php else: ?>
                                        <!-- Simple Menu Item -->
                                        <?php if(isset($item['is_logout']) && $item['is_logout']): ?>
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>