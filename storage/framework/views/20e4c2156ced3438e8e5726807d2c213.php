...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-layout','data' => ['title' => 'Registration Form - PART-A','subtitle' => 'SCHEDULE-I | PART-1: GENERAL INFORMATION','step' => 'Step 1 of 10: General Information']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Registration Form - PART-A','subtitle' => 'SCHEDULE-I | PART-1: GENERAL INFORMATION','step' => 'Step 1 of 10: General Information']); ?>
    ...
    <div class="pt-10 border-t border-slate-100 flex flex-col items-center gap-5">
        <div class="flex flex-col sm:flex-row gap-4 w-full max-w-2xl justify-center">
            ...
            <a href="<?php echo e(route('registration_form_part2')); ?>"
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/registration_form_part1.blade.php ENDPATH**/ ?>