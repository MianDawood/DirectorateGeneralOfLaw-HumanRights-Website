        ...
        <div class="relative group overflow-hidden bg-white">
            <div id="hero-slider" class="relative h-[400px] lg:h-[600px] overflow-hidden">
                ...
                <div class="slide absolute inset-0 transition-opacity duration-1000 opacity-100 z-10">
                    <img src="<?php echo e(asset('images/hero image 1.jpg')); ?>" alt="Innovation Award" class="w-full h-full object-cover" />
                ...
                <div class="slide absolute inset-0 transition-opacity duration-1000 opacity-0 z-0">
                    <img src="<?php echo e(asset('images/hero image 2.png')); ?>" alt="Legal Reforms" class="w-full h-full object-cover" />
                    <div class="absolute inset-0 bg-gradient-to-r from-[#123B2D]/90 via-[#123B2D]/50 to-transparent">
                    </div>
                    <div
                        class="hero-content absolute inset-y-0 left-0 w-full md:w-3/4 flex flex-col justify-center p-6 lg:p-24 z-20">
                ...
                <!-- Slide 3 -->
                <div class="slide absolute inset-0 transition-opacity duration-1000 opacity-0 z-0">
                    <img src="<?php echo e(asset('images/hero image 3.png')); ?>" alt="Digital Services" class="w-full h-full object-cover" />
                    <div class="absolute inset-0 bg-gradient-to-r from-[#123B2D]/90 via-[#123B2D]/50 to-transparent">
                    </div>
                    <div
                        class="hero-content absolute inset-y-0 left-0 w-full md:w-3/4 flex flex-col justify-center p-6 lg:p-24 z-20">
                ...
                <!-- Slide 4 -->
                <div class="slide absolute inset-0 transition-opacity duration-1000 opacity-0 z-0">
                    <img src="<?php echo e(asset('images/hero image 4.jpg')); ?>" alt="DG sb Session" class="w-full h-full object-cover" />
                    <div class="absolute inset-0 bg-gradient-to-r from-[#123B2D]/90 via-[#123B2D]/50 to-transparent">
                    </div>
                    <div
                        class="hero-content absolute inset-y-0 left-0 w-full md:w-3/4 flex flex-col justify-center p-6 lg:p-24 z-20">
                ...
                <!-- Slide 5 -->
                <div class="slide absolute inset-0 transition-opacity duration-1000 opacity-0 z-0">
                    <img src="<?php echo e(asset('images/hero image 5.jpg')); ?>" alt="DG sb Meeting" class="w-full h-full object-cover" />
                    <div class="absolute inset-0 bg-gradient-to-r from-[#123B2D]/90 via-[#123B2D]/50 to-transparent">
                    </div>
                    <div
                        class="hero-content absolute inset-y-0 left-0 w-full md:w-3/4 flex flex-col justify-center p-6 lg:p-24 z-20">
                    ...
                    <div class="h-full overflow-y-auto p-6 scrollbar-thin">
                        ...
                        <h4
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-[10px] font-medium text-slate-400 capitalize"><?php echo e($publication->file_type); ?> • <?php echo e($publication->file_size); ?></span>
            ...
            <div class="marquee-track flex items-center gap-10 md:gap-16">
                <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($partner->url ?: '#'); ?>"
                       target="<?php echo e($partner->url ? '_blank' : '_self'); ?>"
