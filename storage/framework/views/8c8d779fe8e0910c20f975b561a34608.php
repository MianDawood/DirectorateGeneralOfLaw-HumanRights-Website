...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <?php if($news->image_path): ?>
                                    <div class="mt-2">
                                        <img src="<?php echo e(asset('storage/' . $news->image_path)); ?>" alt="Current image"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" name="published_date" id="published_date" value="<?php echo e(old('published_date', $news->published_date->format('Y-m-d'))); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" value="<?php echo e(old('order', $news->order)); ?>" min="0"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $news->is_featured) ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-center">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $news->is_active) ? 'checked' : ''); ?>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-4">
                                    <?php $__currentLoopData = $news->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="relative block rounded-lg overflow-hidden border border-gray-200 cursor-pointer group">
                                            <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" alt="News image" class="w-full h-28 object-cover">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/news/edit.blade.php ENDPATH**/ ?>