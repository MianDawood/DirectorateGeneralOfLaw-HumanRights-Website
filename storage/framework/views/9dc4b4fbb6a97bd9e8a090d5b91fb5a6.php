            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90"><?php echo e(Auth::user()->name); ?></p>
                    </div>
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/components/profile/personal-info-card.blade.php ENDPATH**/ ?>