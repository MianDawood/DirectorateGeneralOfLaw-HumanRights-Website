    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" data-field="cnic_number" required placeholder="XXXXX-XXXXXXX-X"
                    class="w-full input-compact bg-slate-50 border border-slate-200 rounded-lg">
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" data-field="designation" required placeholder="Designation"
                    class="w-full input-compact bg-slate-50 border border-slate-200 rounded-lg">
            </div>
            <div>
        ...
        <div>
            ...
            <textarea data-field="residential_address" required rows="2" placeholder="Complete address"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="tel" data-field="mobile" required placeholder="+92-3XX-XXXXXXX"
                    class="w-full input-compact bg-slate-50 border border-slate-200 rounded-lg">
            </div>
            <div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/partials/board_member_row.blade.php ENDPATH**/ ?>