    ...
    <form method="POST" action="<?php echo e(route('admin.ngo-required-documents.update')); ?>" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="sticky bottom-6 flex items-center justify-end">
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-2 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex items-center gap-3">
                <a href="<?php echo e(route('admin.ngo-required-documents.edit')); ?>" class="px-6 py-3 text-sm font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 transition">Reset</a>
