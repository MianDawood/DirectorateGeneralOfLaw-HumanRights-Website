...
<div class="px-4 py-8 mx-auto max-w-5xl"
     x-data="docManager(<?php echo e(json_encode($documents)); ?>)">
    ...
    <form method="POST" action="<?php echo e(route('admin.ngo-required-documents.update')); ?>" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-end">
                <button type="submit" class="inline-flex items-center px-8 py-3 bg-brand-500 hover:bg-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700 text-white text-sm font-bold rounded-lg">
                    Save All Documents
                </button>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/ngo-required-documents/edit.blade.php ENDPATH**/ ?>