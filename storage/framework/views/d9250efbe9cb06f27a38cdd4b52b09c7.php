...
<head>
    ...
    <title><?php echo e($title ?? ($settings->meta_title ?? 'Directorate of Human Rights | Khyber Pakhtunkhwa')); ?></title>
    ...
    <header id="mainHeader"
            ...
            <div class="max-w-[1536px] mx-auto flex justify-between items-center">
                ...
                <div class="flex items-center gap-4 lg:gap-6 group cursor-pointer transition-all-custom">
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>" alt="Directorate Logo"
                ...
                <!-- Campaign Highlights -->
                <?php if($headerCampaigns->isNotEmpty()): ?>
                    <div class="hidden xl:block w-[500px]" id="campaignHighlights">

                        <div class="grid <?php echo e($headerCampaigns->count() === 1 ? 'grid-cols-1' : 'grid-cols-2'); ?> gap-3"
                            style="margin: 10px;">

                            <?php $__currentLoopData = $headerCampaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a target="__blank" href="<?php echo e($campaign->url); ?>"
                                    ...
                                    <div style="height: 50px"
                                        class="w-full <?php echo e($headerCampaigns->count() === 1 ? 'h-[180px]' : 'h-[120px]'); ?>">
                                        <img src="<?php echo e(asset('storage/' . $campaign->image_path)); ?>"
                                            alt="<?php echo e($campaign->title ?: 'Campaign banner'); ?>"
                                            class="w-full h-full object-fill">
                                    </div>

                                    <!-- Campaign Title -->
                                    <?php if($campaign->title): ?>
                                        <div class="p-1">
            ...
            <div class="max-w-[1536px] mx-auto px-6 lg:px-20">
                <ul class="flex items-center justify-center gap-1">
                    <li><a href="<?php echo e(route('home')); ?>"
                            class="flex items-center gap-2 px-5 py-4 text-white <?php echo e(request()->routeIs('home') ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm"><i
                    ...
                    <li class="group relative">
                        ...
                        <div
                            ...
                            <div class="flex flex-col">
                                ...
                                <?php $__currentLoopData = $whoWeArePages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('page.show', $p->slug)); ?>"
                                        class="px-4 py-3 text-slate-700 <?php echo e(request()->route('slug') === $p->slug ? 'bg-[#123B2D]/5 text-[#123B2D]' : 'hover:bg-[#123B2D]/5 hover:text-[#123B2D]'); ?> rounded-lg transition-colors flex items-center justify-between group/item text-sm">
                                        <?php echo e($p->title); ?>

                                        <i data-lucide="chevron-right"
                                            class="w-3 h-3 <?php echo e(request()->route('slug') === $p->slug ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'); ?> group-hover/item:opacity-100 group-hover/item:translate-x-0 transition-all"></i>
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <li class="group relative">
                        <a href="<?php echo e(route('ngo_required_documents')); ?>"
                            class="flex items-center gap-2 px-5 py-4 text-white <?php echo e(request()->routeIs('ngo_*', 'registration_form_*') || $ngoRegistrationPages->contains('slug', request()->route('slug')) ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm"><span>NGO
                        ...
                        <div
                            ...
                            <div class="flex flex-col">
                                ...
                                <a href="<?php echo e(route('ngo_registered')); ?>"
                                    ...
                                    NGOs</a>
                                <a href="<?php echo e(route('ngo_suspended')); ?>"
                                    class="px-4 py-3 text-slate-700 hover:bg-[#123B2D]/5 hover:text-[#123B2D] rounded-lg transition-colors flex items-center gap-3 text-sm"><i
                                        data-lucide="x-circle" class="w-4 h-4 text-[#02B1EB]"></i>Suspended NGOs</a>

                                <?php $__currentLoopData = $ngoRegistrationPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('page.show', $p->slug)); ?>"
                                        class="px-4 py-3 text-slate-700 <?php echo e(request()->route('slug') === $p->slug ? 'bg-[#123B2D]/5 text-[#123B2D]' : 'hover:bg-[#123B2D]/5 hover:text-[#123B2D]'); ?> rounded-lg transition-colors flex items-center justify-between group/item text-sm">
                    ...
                    <li><a href="<?php echo e(route('resources')); ?>"
                            class="flex items-center gap-2 px-5 py-4 text-white <?php echo e(request()->routeIs('resources') ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm"><span>Resources</span></a>
                    </li>

                    <!-- Dynamic Pages -->
                    <?php $__currentLoopData = $topLevelPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <?php if($hasChildren): ?>
                            <li class="group relative">
                                <a href="<?php echo e(route('page.show', $page->slug)); ?>"
                                    class="flex items-center gap-2 px-5 py-4 text-white <?php echo e($isHierarchyActive ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col">
                                        <?php $__currentLoopData = $page->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('page.show', $child->slug)); ?>"
                                                class="px-4 py-3 text-slate-700 <?php echo e(request()->routeIs('page.show') && request()->route('slug') === $child->slug ? 'bg-[#123B2D]/5 text-[#123B2D]' : 'hover:bg-[#123B2D]/5 hover:text-[#123B2D]'); ?> rounded-lg transition-colors flex items-center justify-between group/item text-sm">
                                                <?php echo e($child->title); ?>

                                                <i data-lucide="chevron-right"
                                                    class="w-3 h-3 <?php echo e(request()->routeIs('page.show') && request()->route('slug') === $child->slug ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'); ?> group-hover/item:opacity-100 group-hover/item:translate-x-0 transition-all"></i>
                                            </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                        ...
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e(route('page.show', $page->slug)); ?>"
                                    class="flex items-center gap-2 px-5 py-4 text-white <?php echo e(request()->routeIs('page.show') && request()->route('slug') === $page->slug ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm">
                                    <span><?php echo e($page->title); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    ...
                    <li><a href="<?php echo e(route('contact_us')); ?>"
                            class="flex items-center gap-2 px-5 py-4 text-white <?php echo e(request()->routeIs('contact_us') ? 'bg-[#02B1EB]' : 'hover:bg-white/10'); ?> transition-all-custom font-medium text-sm"><span>Contact
                                Us</span></a></li>
                </ul>
            </div>
        </nav>
        ...
        <div id="mobileMenuContent"
            ...
            <div class="flex items-center justify-between p-6 border-b border-slate-100">
                <a href="<?php echo e(route('home')); ?>">
                    <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>" class="h-10 w-auto" alt="Logo">
                </a>
            ...
            <div class="flex-1 overflow-y-auto p-6 scrollbar-none space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <nav class="space-y-1">
                        <a href="<?php echo e(route('home')); ?>"
                            class="flex items-center gap-3 p-3 rounded-xl text-slate-700 font-bold <?php echo e(request()->routeIs('home') ? 'bg-slate-50 text-primary' : 'hover:bg-slate-50 hover:text-primary'); ?> transition-all">
                        ...
                        <div class="mobile-dropdown group">
                            ...
                            <div
                                ...
                                <?php $__currentLoopData = $whoWeArePages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('page.show', $p->slug)); ?>"
                                        class="block p-2 text-sm <?php echo e(request()->route('slug') === $p->slug ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">
                                        <?php echo e($p->title); ?>
                        ...
                        <a href="<?php echo e(route('whatwedo')); ?>"
                            class="flex items-center gap-3 p-3 rounded-xl text-slate-700 font-bold <?php echo e(request()->routeIs('whatwedo') ? 'bg-slate-50 text-primary' : 'hover:bg-slate-50 hover:text-primary'); ?> transition-all">
                        ...
                        <div class="mobile-dropdown group">
                            <div
                                ...
                                <button class="p-2 dropdown-trigger">
                                    <i data-lucide="chevron-down"
                                        class="w-4 h-4 transition-transform duration-300 dropdown-icon <?php echo e(request()->routeIs('ngo_*', 'registration_form_*') || $ngoRegistrationPages->contains('slug', request()->route('slug')) ? 'rotate-180' : ''); ?>"></i>
                                </button>
                            </div>
                            <div
                                class="<?php echo e(request()->routeIs('ngo_*', 'registration_form_*') || $ngoRegistrationPages->contains('slug', request()->route('slug')) ? '' : 'hidden'); ?> space-y-1 mt-1 ml-11 dropdown-content">
                                <a href="<?php echo e(route('ngo_required_documents')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_required_documents') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Required
                                    Documents</a>
                                <a href="<?php echo e(route('ngo_guidelines')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_guidelines') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Registration
                                    Guidelines</a>
                                <a href="<?php echo e(route('ngo_directives')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_directives') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Mandatory
                                    Directives</a>
                                <a href="<?php echo e(route('ngo_notices')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_notices') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Latest
                                    Notice Board</a>
                                <a href="<?php echo e(route('registration_form_part1')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('registration_form_*') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Online
                                    Registration</a>
                                <a href="<?php echo e(route('ngo_registered')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_registered') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Registered
                                    NGOs</a>
                                <a href="<?php echo e(route('ngo_suspended')); ?>"
                                    class="block p-2 text-sm <?php echo e(request()->routeIs('ngo_suspended') ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">Suspended
                                    NGOs</a>
                                <?php $__currentLoopData = $ngoRegistrationPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('page.show', $p->slug)); ?>"
                                        class="block p-2 text-sm <?php echo e(request()->route('slug') === $p->slug ? 'text-primary font-bold' : 'text-slate-500'); ?> italic">
                        ...
                        <a href="<?php echo e(route('resources')); ?>"
                            class="flex items-center gap-3 p-3 rounded-xl text-slate-700 font-bold <?php echo e(request()->routeIs('resources') ? 'bg-slate-50 text-primary' : 'hover:bg-slate-50 hover:text-primary'); ?> transition-all">
                            <i data-lucide="book-open" class="w-5 h-5"></i> Resources
                        </a>

                        <?php $__currentLoopData = $mobileTopLevelPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $hasChildren = $page->children->count() > 0;
                                $isHierarchyActive =
                                    request()->routeIs('page.show') &&
                            ...
                            <?php if($hasChildren): ?>
                                <div class="mobile-dropdown group">
                                    <div
                                        class="flex items-center justify-between w-full p-3 rounded-xl <?php echo e($isHierarchyActive ? 'bg-slate-50 text-primary' : 'text-slate-700 hover:bg-slate-50 hover:text-primary'); ?> font-bold transition-all">
                                        <a href="<?php echo e(route('page.show', $page->slug)); ?>"
                                            class="flex items-center gap-3 flex-1">
                                            <i data-lucide="file-text" class="w-5 h-5"></i> <?php echo e($page->title); ?>

                                        </a>
                                        <button class="p-2 dropdown-trigger">
                                            <i data-lucide="chevron-down"
                                                class="w-4 h-4 transition-transform duration-300 dropdown-icon <?php echo e($isHierarchyActive ? 'rotate-180' : ''); ?>"></i>
                                        </button>
                                    </div>
                                    <div
                                        class="<?php echo e($isHierarchyActive ? '' : 'hidden'); ?> space-y-1 mt-1 ml-11 dropdown-content">
                                        <?php $__currentLoopData = $page->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('page.show', $child->slug)); ?>"
                                                class="block p-2 text-sm <?php echo e(request()->routeIs('page.show') && request()->route('slug') === $child->slug ? 'text-primary font-bold' : 'text-slate-500'); ?> italic"><?php echo e($child->title); ?></a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            <?php else: ?>
                                <a href="<?php echo e(route('page.show', $page->slug)); ?>"
                                    class="flex items-center gap-3 p-3 rounded-xl text-slate-700 font-bold <?php echo e(request()->routeIs('page.show') && request()->route('slug') === $page->slug ? 'bg-slate-50 text-primary' : 'hover:bg-slate-50 hover:text-primary'); ?> transition-all">
                                    <i data-lucide="file-text" class="w-5 h-5"></i> <?php echo e($page->title); ?>
                        ...
                        <a href="<?php echo e(route('contact_us')); ?>"
                            class="flex items-center gap-3 p-3 rounded-xl text-slate-700 font-bold <?php echo e(request()->routeIs('contact_us') ? 'bg-slate-50 text-primary' : 'hover:bg-slate-50 hover:text-primary'); ?> transition-all">
                ...
                <div class="p-6 bg-slate-50 rounded-2xl space-y-6">
                    ...
                    <div class="space-y-4">
                        <?php if($settings->contact_email): ?>
                            <a href="mailto:<?php echo e($settings->contact_email); ?>" class="flex items-center gap-3 text-slate-600 group">
                                <div
                                ...
                                <span class="text-sm font-bold"><?php echo e($settings->contact_email); ?></span>
                            </a>
                        <?php endif; ?>
                        <?php if($settings->contact_phone): ?>
                            <div class="flex items-center gap-3 text-slate-600 group">
                                ...
                                <span class="text-sm font-bold"><?php echo e($settings->contact_phone); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                    ...
                    <div class="mt-6 space-y-3 text-sm text-slate-300/90">
                        <?php if($settings->contact_address): ?>
                            <p class="leading-relaxed">
                                <?php echo nl2br(e($settings->contact_address)); ?>
                        ...
                        <div class="pt-3 space-y-2 text-slate-400">
                            <?php if($settings->contact_phone): ?>
                                <p class="flex items-center gap-2"><i data-lucide="phone"
                                        class="w-4 h-4 shrink-0"></i> <span><?php echo e($settings->contact_phone); ?></span></p>
                            <?php endif; ?>
                            <?php if($settings->contact_email): ?>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li>
                            <a href="<?php echo e(route('track.complaint')); ?>"
                                class="flex items-center gap-3 text-sm transition-colors group">
                                <i data-lucide="chevron-right"
                                    class="w-4 h-4"></i>
                        ...
                        <li>
                            <a href="<?php echo e(route('verify.ngo')); ?>"
                                class="flex items-center gap-3 text-sm transition-colors group">
                                <i data-lucide="chevron-right"
                                    class="w-4 h-4 "></i>
        ...
        <div class="border-t border-[#123B2D]/30 bg-[#071a12] py-8">
            <div
                ...
                <div class="flex flex-col md:flex-row items-center gap-4">
                    <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>"
                    ...
                    <div>
                        <p
                            ...
                            &copy; 2026 <?php echo e($settings->site_name ?? 'Directorate General of Law and Human Rights, Khyber Pakhtunkhwa.'); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/components/layout.blade.php ENDPATH**/ ?>