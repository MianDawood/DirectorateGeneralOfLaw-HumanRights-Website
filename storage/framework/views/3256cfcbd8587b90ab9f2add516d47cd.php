<?php $__env->startSection('content'); ?>
    <div class="px-4 py-8 mx-auto max-w-7xl">
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Welcome back, <?php echo e(Auth::user()->name); ?></h1>
            ...
            <div class="relative p-6 overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['registrations']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('admin.registration-applications.index')); ?>" class="text-sm font-medium text-brand-500 hover:text-brand-600 transition">Manage Registrations &rarr;</a>
                </div>
            </div>
            ...
            <div class="relative p-6 overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['messages']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('admin.official-messages.index')); ?>" class="text-sm font-medium text-success-500 hover:text-success-600 transition">Manage Messages &rarr;</a>
                </div>
            </div>
            ...
            <div class="relative p-6 overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['complaints']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('admin.complaints.index')); ?>" class="text-sm font-medium text-warning-500 hover:text-warning-600 transition">Manage Complaints &rarr;</a>
                </div>
            </div>
            ...
            <div class="relative p-6 overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['tenders']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('admin.tenders.index')); ?>" class="text-sm font-medium text-error-500 hover:text-error-600 transition">Manage Tenders &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12">
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <a href="<?php echo e(route('admin.site-settings.homepage.edit')); ?>" class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700/50">
                ...
                <a href="<?php echo e(route('admin.news-events.index')); ?>" class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700/50">
                ...
                <a href="<?php echo e(route('admin.official-messages.index')); ?>" class="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700/50">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/index.blade.php ENDPATH**/ ?>