        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form method="GET" action="<?php echo e(route('admin.registration-applications.index')); ?>" class="mb-6 flex flex-wrap items-end gap-2">
                        <div>
                        ...
                        <div>
                            ...
                            <select name="thematic_area" id="thematic_area"
                                ...
                                <option value="">All</option>
                                <?php $__currentLoopData = $thematicAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex gap-2">
                            <button type="submit"
                                    class="bg-gray-800 hover:bg-gray-900 dark:bg-brand-600 dark:hover:bg-brand-700 text-white font-bold py-2 px-3 rounded text-sm">Apply</button>
                            <a href="<?php echo e(route('admin.registration-applications.index')); ?>"
...
?>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-sm text-gray-500">Showing <?php echo e($applications->total()); ?> record(s)</span>
                        <span class="flex gap-2">
                            <a href="<?php echo e(route('admin.registration-applications.export', array_merge(['format' => 'pdf'], $query))); ?>"
                               class="inline-flex items-center bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-3 rounded text-sm">Export PDF</a>
                            <a href="<?php echo e(route('admin.registration-applications.export', array_merge(['format' => 'xlsx'], $query))); ?>"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <?php echo e($application->application_no); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                                            <?php echo e($application->profile?->organization_name ?: 'N/A'); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($application->profile?->district ?: '—'); ?>

                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500 max-w-xs truncate">
                                            <?php echo e($application->profile?->thematic_areas ?: '—'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($color); ?>">
                                                <?php echo e(ucwords(str_replace('_', ' ', $application->status))); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e(optional($application->submitted_at)->format('M d, Y h:i A') ?? '—'); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="<?php echo e(route('admin.registration-applications.show', $application)); ?>?return_to=<?php echo e(urlencode(url()->full())); ?>"
                                                   class="text-blue-600 hover:text-blue-900">View</a>
                                                <a href="<?php echo e(route('admin.registration-applications.edit', $application)); ?>?return_to=<?php echo e(urlencode(url()->full())); ?>"
                                                ...
                                                <?php endif; ?>
                                                <form method="POST" action="<?php echo e(route('admin.registration-applications.destroy', $application)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/registration-applications/index.blade.php ENDPATH**/ ?>