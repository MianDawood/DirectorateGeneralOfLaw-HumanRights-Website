                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            <div class="bg-gray-50 rounded-lg p-6">
                                <h2 class="text-xl font-semibold text-gray-900 mb-4"><?php echo e($news->title); ?></h2>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="text-gray-600 bg-white p-3 rounded border"><?php echo e($news->excerpt); ?></p>
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        ...
                                        <dd class="text-sm text-gray-900"><?php echo e($news->published_date->format('M j, Y')); ?></dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-medium text-gray-500 uppercase tracking-wide">Display Order</dt>
                                        <dd class="text-sm text-gray-900"><?php echo e($news->order); ?></dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-medium text-gray-500 uppercase tracking-wide">Created</dt>
                                        <dd class="text-sm text-gray-900"><?php echo e($news->created_at->format('M j, Y g:i A')); ?></dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-medium text-gray-500 uppercase tracking-wide">Last Updated</dt>
                                        <dd class="text-sm text-gray-900"><?php echo e($news->updated_at->format('M j, Y g:i A')); ?></dd>
                                    </div>
                                </dl>
                            </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.news.destroy', $news)); ?>"
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                    <?php $__currentLoopData = $news->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rounded-lg overflow-hidden border border-gray-200">
                                            <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" alt="Gallery image" class="w-full h-28 object-cover">
                                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/news/show.blade.php ENDPATH**/ ?>