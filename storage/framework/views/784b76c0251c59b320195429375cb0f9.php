                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            ...
                                            <?php if($page->parent_id): ?>
                                                <div class="text-xs text-gray-400">Sub-page of: <?php echo e($page->parent->title); ?></div>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e(optional($page->published_at)->format('M d, Y') ?? 'â€”'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/pages/index.blade.php ENDPATH**/ ?>