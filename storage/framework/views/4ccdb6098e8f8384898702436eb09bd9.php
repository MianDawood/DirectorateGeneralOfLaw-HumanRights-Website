        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.team-members.update', $member)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="position" id="position" value="<?php echo e(old('position', $member->position)); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', $member->phone)); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1">
                                    <?php if($member->image_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $member->image_path)); ?>" alt="<?php echo e($member->name); ?>" class="w-20 h-20 rounded-full object-cover">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="url" name="facebook_url" id="facebook_url" value="<?php echo e(old('facebook_url', $member->facebook_url)); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="url" name="twitter_url" id="twitter_url" value="<?php echo e(old('twitter_url', $member->twitter_url)); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="url" name="instagram_url" id="instagram_url" value="<?php echo e(old('instagram_url', $member->instagram_url)); ?>"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" value="<?php echo e(old('order', $member->order)); ?>" min="0"
                                       class="mt-1 block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/team-members/edit.blade.php ENDPATH**/ ?>