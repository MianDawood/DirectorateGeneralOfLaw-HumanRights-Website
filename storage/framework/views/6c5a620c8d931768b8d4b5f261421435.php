...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mobile-header">
        <a href="<?php echo e(route($backRoute)); ?>" class="p-2 -ml-2 text-slate-600">
            <i data-lucide="arrow-left" class="w-6 h-6"></i>
        </a>
        <img src="<?php echo e($settings->logo ? asset('storage/' . $settings->logo) : asset('images/logo.jpg')); ?>" alt="Logo" class="h-8 w-auto">
    </div>
