    ...
    <section class="py-16 bg-white">
        <div class="max-w-[1200px] mx-auto px-6 lg:px-20">
            <div class="bg-slate-50 rounded-[36px] p-8 md:p-10 border border-slate-100 reveal-on-scroll">
                ...
                <!-- Filter Bar -->
                <form method="GET" action="<?php echo e(route('ngo_registered')); ?>" class="flex flex-wrap items-end gap-4 mb-8 pb-8 border-b border-slate-200">
                    <div>
                        ...
                        <select name="district" class="px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#02B1EB]">
                            ...
                            <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d); ?>" <?php if($district === $d): echo 'selected'; endif; ?>><?php echo e($d); ?></option>
                    ...
                    <div>
                        ...
                        <select name="thematic_area" class="px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#02B1EB]">
                            ...
                            <?php $__currentLoopData = $thematicAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php if($thematicArea === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="flex gap-2">
                        ...
                        <?php if($district || $thematicArea): ?>
                            <a href="<?php echo e(route('ngo_registered')); ?>" class="px-6 py-2.5 bg-slate-200 text-slate-600 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-300 transition-colors">
                                Clear
                            </a>
                        <?php endif; ?>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ngo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-slate-50/80 transition-colors">
                                        ...
                                        <td class="px-5 py-4 text-sm text-slate-600">
                                            <?php echo e($ngo->certificate_issue_date ? \Carbon\Carbon::parse($ngo->certificate_issue_date)->format('d-m-Y') : ($ngo->expiry_date ? \Carbon\Carbon::parse($ngo->expiry_date)->format('d-m-Y') : '-')); ?>
                                        ...
                                        <td class="px-5 py-4 text-sm">
                                            ...
                                            ?>
                                            <span class="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider <?php echo e($color); ?>">
                                                <?php echo e($label); ?>

                                            </span>
                                        </td>
                                        <td class="px-5 py-4 text-center">
                                            <a href="<?php echo e(route('ngo.detail', $ngo->id)); ?>"
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/ngo_registered.blade.php ENDPATH**/ ?>