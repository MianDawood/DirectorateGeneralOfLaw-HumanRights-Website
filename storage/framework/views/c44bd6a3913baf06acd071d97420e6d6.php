...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-layout','data' => ['title' => 'Registration Form - PART-J','subtitle' => 'SCHEDULE-I | PART-10: SECURITY AGREEMENT & ARRANGEMENTS','step' => 'Step 10 of 10: Security Agreement & Arrangements','backRoute' => 'registration_form_part9','backLabel' => 'Back to Part 9']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Registration Form - PART-J','subtitle' => 'SCHEDULE-I | PART-10: SECURITY AGREEMENT & ARRANGEMENTS','step' => 'Step 10 of 10: Security Agreement & Arrangements','backRoute' => 'registration_form_part9','backLabel' => 'Back to Part 9']); ?>
    <section>
        <div class="flex items-center gap-4 mb-10">
            <div class="section-icon bg-[#123B2D] text-white shadow-lg">10</div>
            <div>
                <h2 class="font-outfit text-sm font-black text-slate-900 uppercase tracking-wide">PART-10: Security Agreement and Arrangements</h2>
