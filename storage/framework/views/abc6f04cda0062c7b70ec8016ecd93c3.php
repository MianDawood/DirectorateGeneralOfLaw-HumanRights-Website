...
<main class="bg-slate-50/50">
        ...
        <section class="relative lg:h-[45vh] h-[35vh] flex items-center overflow-hidden">
            <div class="absolute inset-0 z-0">
                <img src="<?php echo e(asset('images/hero image 5.jpg')); ?>" alt="Hero Background" class="w-full h-full object-cover">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal-stagger">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="group bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                            <div class="absolute top-0 right-0 w-32 h-32 <?php echo e($scheme['bg_light']); ?> rounded-full -mr-16 -mt-16 transition-transform group-hover:scale-150 duration-700"></div>

                            <div class="flex items-center justify-between mb-8">
                                <div class="w-12 h-12 <?php echo e($scheme['icon_bg']); ?> rounded-2xl flex items-center justify-center <?php echo e($scheme['icon_text']); ?>">
                                    <i data-lucide="<?php echo e($style['icon']); ?>" class="w-6 h-6"></i>
                                </div>
                            ...
                            <h3 class="font-outfit text-xl font-bold text-slate-900 uppercase mb-4 <?php echo e($scheme['hover_text']); ?> transition-colors">
                            ...
                            <a href="javascript:openNoticeModal(<?php echo e($notice->id); ?>, '<?php echo e($style['icon']); ?>')" class="flex items-center gap-2 <?php echo e($scheme['btn_text']); ?> text-xs font-black uppercase tracking-widest group/btn">
                                Read Full Notice
            ...
            <section class="lg:py-24 py-10 bg-white border-b border-slate-100">
                <div class="max-w-[1536px] mx-auto px-6 lg:px-20">
                    <div class="text-center lg:mb-16 mb-6 reveal-on-scroll">
                        ...
                        <h2 class="font-outfit text-4xl md:text-5xl font-black text-slate-900 uppercase">Public <span class="text-primary italic"><?php echo e($publicNotice->title); ?></span></h2>
                    </div>

                    <div class="bg-white p-2 md:p-8 lg:rounded-[40px] rounded-[0px] shadow-2xl border border-slate-100 reveal-on-scroll">
                        <img src="<?php echo e(asset('storage/' . $publicNotice->image)); ?>" alt="<?php echo e($publicNotice->title); ?>" class="w-full h-auto lg:rounded-[32px] rounded-[0px] shadow-sm">
                    </div>
                </div>
            </section>
        <?php endif; ?>
    ...
    <script>
        ...
        const noticesData = <?php echo json_encode($notices->keyBy('id'), 15, 512) ?>;
...
<?php endif; ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/ngo_notices.blade.php ENDPATH**/ ?>