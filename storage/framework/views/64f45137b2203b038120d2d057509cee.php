                    ...
                    <div class="text-left">
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex -space-x-3">
                                <img src="<?php echo e(asset('images/hero image 1.jpg')); ?>"
                                    class="w-10 h-10 rounded-full border-2 border-white object-cover" alt="User">
                                <img src="<?php echo e(asset('images/hero image 2.png')); ?>"
                                    class="w-10 h-10 rounded-full border-2 border-white object-cover" alt="User">
                                <img src="<?php echo e(asset('images/hero image 3.png')); ?>"
                                    class="w-10 h-10 rounded-full border-2 border-white object-cover" alt="User">
                                <div
                        ...
                        <div class="p-0 sm:p-3 rounded-[24px] sm:rounded-[48px]">
                            ...
                            <div id="imageAccordion"
                                ...
                                <div data-acc-item
                                    ...
                                    style="flex:5">
                                    <img src="<?php echo e(asset('images/hero image 1.jpg')); ?>" alt="Gallery"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/hero image 2.png')); ?>" alt="Gallery"
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/hero image 3.png')); ?>" alt="Gallery"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/hero image 4.jpg')); ?>" alt="Gallery"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                                ...
                                <div data-acc-item
                                    class="acc-item h-full overflow-hidden rounded-[16px] sm:rounded-[32px] relative cursor-pointer min-w-0 transition-all duration-[600ms] [transition-timing-function:cubic-bezier(0.25,1,0.5,1)]"
                                    style="flex:1.2">
                                    <img src="<?php echo e(asset('images/hero image 5.jpg')); ?>" alt="Gallery"
                                        class="w-full h-full object-cover transition-transform duration-[600ms]">
                                    <div
                                        class="acc-icon absolute bottom-3 sm:bottom-6 left-1.5 sm:left-2 w-8 h-8 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 reveal-stagger">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="relative group aspect-square rounded-3xl overflow-hidden cursor-pointer border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
                            ...
                            <img src="<?php echo e($src); ?>" alt="<?php echo e($photo->title ?? 'Gallery Image'); ?>"
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/photogallery.blade.php ENDPATH**/ ?>