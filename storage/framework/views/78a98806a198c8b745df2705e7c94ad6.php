...
<div class="px-4 py-8 mx-auto max-w-5xl"
     x-data="headManager(<?php echo e(json_encode($heads)); ?>)">
    ...
    <form method="POST" action="<?php echo e(route('admin.introductions.update')); ?>" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-6">
            ...
            <?php $__currentLoopData = $introductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $intro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 overflow-hidden transition-all hover:shadow-md">
                    <div class="border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 px-6 py-4 flex items-center justify-between">
                        <h3 class="font-semibold text-gray-900 dark:text-white">Section #<?php echo e($index + 1); ?></h3>
                        <label class="flex items-center gap-2 cursor-pointer group/check">
                            <input type="checkbox" name="introductions[<?php echo e($intro->id); ?>][is_active]" value="1" <?php echo e($intro->is_active ? 'checked' : ''); ?> class="w-5 h-5 rounded border-gray-300 text-brand-600 focus:ring-brand-500 dark:bg-gray-900 dark:border-gray-700 transition">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="introductions[<?php echo e($intro->id); ?>][title]" value="<?php echo e(old('introductions.' . $intro->id . '.title', $intro->title)); ?>" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-1">
                                        <input type="file" name="introductions[<?php echo e($intro->id); ?>][image]" accept="image/*" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 transition">
                                    </div>
                                    <?php if($intro->image): ?>
                                        <div class="relative group">
                                            <img src="<?php echo e($introImageUrl($intro->image)); ?>" class="h-16 w-16 object-cover rounded-lg border border-gray-200 shadow-sm" alt="Preview">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="introductions[<?php echo e($intro->id); ?>][description]" rows="5" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white"><?php echo e(old('introductions.' . $intro->id . '.description', $intro->description)); ?></textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <template x-if="head.image">
                                        <img :src="head.image.startsWith('uploads/') || head.image.startsWith('images/') ? '<?php echo e(asset('')); ?>' + head.image : '<?php echo e(asset('storage/')); ?>' + head.image" class="w-10 h-10 object-cover rounded-lg border">
                                    </template>
                                </div>
                            </div>
        ...
        <div class="sticky bottom-6 flex items-center justify-end">
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-2 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex items-center gap-3">
                <a href="<?php echo e(route('admin.introductions.edit')); ?>" class="px-6 py-3 text-sm font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 transition">Reset Changes</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/dashboard/introductions/edit.blade.php ENDPATH**/ ?>