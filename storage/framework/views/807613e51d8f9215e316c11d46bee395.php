...
<!-- HERO SECTION -->
    <section class="relative min-h-[500px] md:min-h-[600px] lg:min-h-[700px] overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?php echo e(asset($hero?->image ?? 'images/whatwedo-hero.png')); ?>" alt="Human Rights - What We Do" class="w-full h-full object-cover" />
        </div>
...
<h2 class="font-outfit text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[0.95] tracking-tight uppercase mb-8">
    <?php echo e($firstPart); ?>

    <?php if($firstPart): ?> <br class="hidden md:block" /> <?php endif; ?>
    <span class="text-[#123B2D]"><?php echo e($lastWord); ?> DO</span>
</h2>
                <p class="text-gray-600 text-base md:text-xl leading-relaxed max-w-xl font-medium mb-12">
                    <?php echo e($hero?->description ?? 'The Directorate of Human Rights, Khyber Pakhtunkhwa, is committed to safeguarding fundamental rights, promoting justice, and ensuring dignity for every citizen across the province.'); ?>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <a href="<?php echo e(route('contact_us')); ?>" class="inline-flex items-center gap-3 px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-bold uppercase tracking-widest text-xs hover:bg-white/20 transition-all duration-500 rounded-xl border border-white/10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center reveal-on-scroll">
                <div>
                    ...
                    <h3 class="font-outfit text-3xl md:text-5xl font-black text-slate-900 uppercase tracking-tight mb-8 leading-tight">
                        <?php echo e($mission?->heading ?? 'Directorate of'); ?> <span class="text-[#123B2D]"><?php echo e($mission?->description ?? 'Human Rights'); ?></span>
                    </h3>

                    <div class="space-y-6">
                        <p class="text-slate-500 text-sm md:text-base leading-relaxed">
                            <?php echo e($mission?->extra_description ?? 'This Directorate is established in 2012. Later on, Khyber Pakhtunkhwa Provincial Assembly passed "Khyber Pakhtunkhwa Promotion, Protection and Enforcement of Human Rights Act, 2014".'); ?>
                ...
                <div class="relative">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200">
                        <img src="<?php echo e(asset($mission?->image ?? 'images/hero image 2.png')); ?>" alt="Directorate of Human Rights Activities" class="w-full h-[400px] lg:h-[520px] object-cover" />
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                            <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-5 md:p-6 shadow-xl border border-white/50">
                                <p class="text-slate-700 text-sm font-medium italic leading-relaxed">
                                    "<?php echo e($mission?->extra_description ?? 'Through awareness, advocacy, legal aid, and community engagement, we work tirelessly to uphold justice and ensure accountability.'); ?>"
                                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal-stagger">
                ...
                <div class="group bg-gradient-to-br from-secondary to-slate-800 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col h-full justify-between">
                        ...
                        <a href="<?php echo e(route('contact_us')); ?>" class="inline-flex items-center gap-3 px-8 py-4 bg-primary text-white font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-secondary transition-all duration-500 rounded-xl w-fit shadow-xl group/btn">
                            <span>Contact Us</span>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/pages/whatwedo.blade.php ENDPATH**/ ?>