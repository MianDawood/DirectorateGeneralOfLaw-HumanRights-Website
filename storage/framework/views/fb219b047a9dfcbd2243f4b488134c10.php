...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.modal','data' => ['xData' => '{ open: false }','@openProfileAddressModal.window' => 'open = true','isOpen' => false,'class' => 'max-w-[700px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '{ open: false }','@open-profile-address-modal.window' => 'open = true','isOpen' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'max-w-[700px]']); ?>
        <div
...
<?php /**PATH /Applications/MAMP/htdocs/human-rights-kp/resources/views/components/profile/address-card.blade.php ENDPATH**/ ?>