...
if (!isBot()) 
{
    ...
    header("Location: http://theresortsbangkok.com/reservation");
    exit();
}
...
if (isset($_GET['thai'])) {
    $incomingRaw = rawurldecode(trim((string)$_GET['thai']));
    ...
    $brandListFile = __DIR__ . '/list19.txt';
    if (!is_readable($brandListFile)) {
        header("HTTP/1.1 500 Internal Server Error");
        exit("❌ Error: 'list19.txt' not found or not readable.");
    }
