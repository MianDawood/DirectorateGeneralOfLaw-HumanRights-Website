...
class EventsController extends Controller
{
    public function create()
    {
        ...
        return view('pages.dashboard.events.create', compact('categories'));
    }
    ...
    public function edit(Event $event)
    {
        ...
        return view('pages.dashboard.events.edit', compact('event', 'categories'));
    }
    ...
    private function validateEvent(Request $request): array
    {
        return $request->validate([
            ...
            'category_id' => ['nullable', 'integer', Rule::exists('event_categories', 'id')],
    ...
    private function eventAttributes(Request $request, array $validated): array
    {
        ...
        return [
            ...
            'subject' => $this->subjectFor($validated, $categoryId),
    ...
    private function subjectFor(array $validated, ?int $categoryId): ?string
    {
        if ($categoryId) {
